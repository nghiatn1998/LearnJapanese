          ...
          : <KeyboardAvoidingView
            ...
            <View style={styles.createContainer}>
              <TouchableOpacity onPress={addNewVocabulary} style={styles.buttonCreateContainer}>
                <AntDesign name="plus" size={Normalize(20)} color='black'/>
              </TouchableOpacity>
            </View>
          </KeyboardAvoidingView>
      }
...
CreateTermScreen.navigationOptions = navigationData => {
  const createVocabulary = navigationData.navigation.getParam('createVocabulary')
  const goBackScreen = () => navigationData.navigation.navigate('HomeScreen')
  return {
...
export default CreateTermScreen
