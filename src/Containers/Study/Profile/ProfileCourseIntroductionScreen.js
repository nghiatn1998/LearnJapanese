...
const ProfileCourseIntroductionScreen = (props) => {
...
ProfileCourseIntroductionScreen.navigationOptions = (navigationData) => {
  return {
...
export default ProfileCourseIntroductionScreen
