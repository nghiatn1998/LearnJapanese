...
const SocialSignUpForm = (props) => {
  const {signUpWithFacebook, signUpWithGoogle} = props
  return (
    <View style={styles.formContainer}>
      <TouchableOpacity onPress={signUpWithFacebook} style={styles.facebookContainer}>
      ...
      <TouchableOpacity onPress={signUpWithGoogle} style={styles.googleContainer}>
