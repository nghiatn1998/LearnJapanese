...
const LicenseSignInForm = (props) => {
  const {isLoading, formState, signInHandler} = props
  return (
    <React.Fragment>
      ...
      <View style={styles.signInContainer}>
        {
          isLoading ? (
            ...
            <TouchableOpacity disabled={formState.formIsValid ? false : true} onPress={signInHandler}
...
export default LicenseSignInForm